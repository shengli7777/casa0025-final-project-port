...
- **Ship candidate detection layer**: Threshold-based VV detections with connected-pixel and size filtering are displayed as an approximate ship candidate layer, providing a visual indicator of maritime activity density.
...
Figure: Screenshot of the interactive application showing SAR imagery, ship candidate detection layer, and monthly backscatter chart.
